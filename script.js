...
let playing = false;
let volume = 0.75;
let isDragging = false; // Zapobiega szarpaniu paska podczas przewijania
...
// Obsługa paska postępu (NAPRAWIONA)
audio.ontimeupdate = () => {
...
progressBar.oninput = () => {
    if (audio.duration) {
        ...
        audio.currentTime = seekTime; // Natychmiastowe przewijanie podczas ruchu
        updateTimeDisplay();
    }
};
