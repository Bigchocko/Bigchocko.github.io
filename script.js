...
playBtn.onclick = () => {
    if (playing) {
        ...
        audio.play().catch(e => console.log("Zablokowano autoodtwarzanie"));
...
// LICZNIK ODWIEDZIN - GLOBALNY
async function updateGlobalCounter() {
    const counterElement = document.getElementById('visit-count');
    // Używamy unikalnej nazwy dla Twojej strony
    const namespace = 'bigchocko.github.io';
    const key = 'studio-visits-v1';
    ...
    try {
        ...
        console.warn("Licznik API niedostępny.");
        counterElement.innerText = "000001";
    }
}
updateGlobalCounter();
